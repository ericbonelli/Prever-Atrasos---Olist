...
dia_semana = st.selectbox("📅 Dia da semana da compra",
                          ...
                          help="Dia em que o cliente fez a compra (0 = segunda).")
...
if st.button("🔮 Prever Atraso"):
    ...
    if pred == 1:
        st.error(f"⚠️ Alta chance de **atraso na entrega**.\nProbabilidade: {prob:.1%}")
    else:
